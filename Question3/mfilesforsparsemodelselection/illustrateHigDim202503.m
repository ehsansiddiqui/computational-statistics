...
dotoptg = {'o','markersize',8,'markeredgecolor',fg,'markerfacecolor',fg};
dotoptr = {'o','markersize',8,'markeredgecolor','r','markerfacecolor','r'};
linedotopt = {'-o','linewidth',3,'markersize',4,'color'};
...
lineoptb = {'linewidth',3,'color','b'};
lineoptr = {'linewidth',3,'color','r'};
lineoptg = {'linewidth',3,'color',fg};
fontsize = 18;
...
figure(1)
plot(beta,'r','linewidth',2)
axy = axis;
hold on
plot(betahat,'b','linewidth',2)
xlabel('modelsize');  
...
axy = axis;
hold on
plot(muhat,'b','linewidth',2)
xlabel('observation index (sample point)');  
...
xlabel('modelsize');  
ylabel('log penalty parameter ($ \log(\lambda) $')
